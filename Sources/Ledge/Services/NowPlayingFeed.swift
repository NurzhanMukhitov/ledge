...
/// snapshots. See `Sources/LedgeMediaHelper/helper.m` for why perl is the host.
@MainActor
final class NowPlayingFeed {
    ...
    private var helperPath: String? {
        Bundle.main.path(forResource: "libledgemedia", ofType: "dylib")
    }
    ...
    private func launch() {
        ...
        do {
            ...
            NSLog("Ledge: helper failed to launch: \(error.localizedDescription)")
            onUnavailable?()
            return
        }
    ...
    private func write(_ line: String) {
        ...
        do {
            ...
            NSLog("Ledge: helper write failed: \(error.localizedDescription)")
        }
    }
