...
final class SnippetStore: ObservableObject {
    ...
    /// `~/Library/Application Support/Ledge/snippets.json`. A plain array of
    ...
    func reload() {
        ...
        do {
            ...
            // lost file.
            fileBroken = true
            NSLog("Ledge: snippets.json is not readable: \(error.localizedDescription)")
        }
    }
    ...
    func add(label: String, text: String) {
        ...
        guard !fileBroken else {
            NSLog("Ledge: refusing to write over an unreadable snippets.json")
            return
        }
    ...
    private func persist() {
        ...
        do {
            ...
            NSLog("Ledge: cannot write snippets.json: \(error.localizedDescription)")
        }
    }
